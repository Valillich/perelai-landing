...
Perelai will ensure that people authorised to process Customer Personal Data:
...
## Assumptions and mandatory legal review notes — do not publish this section as the DPA

1. Confirm whether the provider is established in the EU and how that affects GDPR/transfer roles.
2. Complete Article 28 particulars and verify actual instructions/roles for analytics, support and
   security reuse.
3. Select correct EU SCC modules only after exporter/importer chains are known; add UK mechanisms only
