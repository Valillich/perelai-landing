...
| G5: Finance/Drivers «выручка, расходы…» | Finance API/UI; `lib/finance-fixture.ts`; ADR-0003; старый `docs/finance-claim-contract.md` требует поправки package-смысла | Owner / разрешённый Business manager; не Administrator; SOLO/STUDIO, RU/UK/EN | **DEPENDENCY: POS1.** Согласовать totals/category/client/trend, scope платежей и summary. Не обещать cash=Revenue, любую per-service детализацию или бухгалтерскую формулу |
